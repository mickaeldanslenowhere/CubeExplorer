...
export const eMoveMatrix: MoveMatrix = {
    [CubeFaces.RIGHT]: [
        { face: CubeFaces.RIGHT, index: 0 }, { face: CubeFaces.RIGHT, index: 1 }, { face: CubeFaces.RIGHT, index: 2 },
        { face: CubeFaces.BACK, index: 5 }, { face: CubeFaces.BACK, index: 4 }, { face: CubeFaces.BACK, index: 3 },
    ...
    [CubeFaces.LEFT]: [
        ...
        { face: CubeFaces.FRONT, index: 5 }, { face: CubeFaces.FRONT, index: 4 }, { face: CubeFaces.FRONT, index: 3 },
