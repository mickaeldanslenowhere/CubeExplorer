...
export const fMoveMatrix: MoveMatrix = {
    right: [
        { face: 'up', index: 6 }, { face: 'right', index: 1 }, { face: 'right', index: 2 },
        { face: 'up', index: 7 }, { face: 'right', index: 4 }, { face: 'right', index: 5 },
        { face: 'up', index: 8 }, { face: 'right', index: 7 }, { face: 'right', index: 8 },
    ],
    up: [
    ...
    left: [
        { face: 'down', index: 2 }, { face: 'left', index: 1 }, { face: 'left', index: 2 },
        { face: 'down', index: 1 }, { face: 'left', index: 4 }, { face: 'left', index: 5 },
        { face: 'down', index: 0 }, { face: 'left', index: 7 }, { face: 'left', index: 8 },
    ],
}