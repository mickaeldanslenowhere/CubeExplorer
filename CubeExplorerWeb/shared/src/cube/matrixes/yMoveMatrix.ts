...
export const yMoveMatrix: MoveMatrix = {
    right: [
        ...
        { face: 'back', index: 5 }, { face: 'back', index: 4 }, { face: 'back', index: 3 },
        { face: 'back', index: 2 }, { face: 'back', index: 1 }, { face: 'back', index: 0 },
    ],
    up: [
    ...
    left: [
        { face: 'front', index: 8 }, { face: 'front', index: 7 }, { face: 'front', index: 6 },
        { face: 'front', index: 5 }, { face: 'front', index: 4 }, { face: 'front', index: 3 },
