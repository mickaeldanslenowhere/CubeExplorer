...
export const sPrimeMoveMatrix: MoveMatrix = {
    right: [
        { face: 'right', index: 0 }, { face: 'down', index: 5 }, { face: 'right', index: 2 },
        { face: 'right', index: 3 }, { face: 'down', index: 4 }, { face: 'right', index: 5 },
        { face: 'right', index: 6 }, { face: 'down', index: 3 }, { face: 'right', index: 8 },
    ],
    up: [
    ...
    left: [
        { face: 'left', index: 0 }, { face: 'up', index: 3 }, { face: 'left', index: 2 },
        { face: 'left', index: 3 }, { face: 'up', index: 4 }, { face: 'left', index: 5 },
        { face: 'left', index: 6 }, { face: 'up', index: 5 }, { face: 'left', index: 8 },
    ],
}